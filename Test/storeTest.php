...
<html lang="en">
	<head>
		...
		<title>3 Columns Right Sidebar | Porto - Multipurpose Website Template</title>	
				...
				<div class="container">
					<div class="row justify-content-center py-2">
						<div class="col-9 col-md-12 text-center">
							<p class="text-color-light font-weight-semibold mb-0">  כל הקטגוריה עד<strong>&nbsp 40% &nbsp </strong><a href="#" class="btn btn-primary-scale-2 btn-modern btn-px-2 btn-py-1 ms-2">לחץ כאן</a> <a href="#" class="btn btn-primary-scale-2 btn-modern btn-px-2 btn-py-1 ms-1 me-2">לחנות</a> <span class="opacity-6 text-1">* להסרה יש ללחוץ איקס בצד הסרגל</span></p>
						</div>
					</div>
				</div>
			</div>
...
<span class="badge badge-ecommerce badge-success">NEW</span>
												...
												<a href="product-details.php?pid=<?php echo htmlentities($row['pid']);?>" class="quick-view text-uppercase font-weight-semibold text-2">
													להזמנה מאובטחת
												</a>
												<a href="shop-product-sidebar-left.html">
													<div class="product-thumb-info-image">
														<img alt="<?php echo htmlentities($row['productName']);?>" class="img-fluid" src="../admin/productimages/<?php echo htmlentities($row['productImage1']);?>">
											...
											<div class="d-flex justify-content-between">
												<div>
													...
													<h3 class="text-3-5 font-weight-medium font-alternative text-transform-none line-height-3 mb-0"><a href="shop-product-sidebar-right.html" class="text-color-dark text-color-hover-primary"><?php echo htmlentities($row['productName']);?></a></h3>
												</div>
											...
											<p class="price text-5 mb-3">
												<span class="sale text-color-dark font-weight-semi-bold"><?php echo htmlentities($row['productPrice']);?></span>
												<span class="amount"><?php echo htmlentities($row['productPriceBeforeDiscount']);?></span>
											</p>
										</div>
									</div>
									<?php } ?> 
								...
								<div class="row mt-4">
									<div class="col">
										<ul class="pagination float-end">
											...
											<li class="page-item active"><a class="page-link" href="<?php if($page_no > 1){ echo "href='?page_no=$previous_page'"; } ?>" class="active">>1</a></li>
											<?php 
...
echo "<li><a href='?page_no=$total_no_of_pages' class='page-link, fa fa-angle-right'></a></li>";
											...
											<li <?php if($page_no >= $total_no_of_pages){ echo "class='page-item disabled'"; } ?> <?php if($page_no < $total_no_of_pages) { echo "href='?page_no=$next_page'"; } ?>>3</a></li>
